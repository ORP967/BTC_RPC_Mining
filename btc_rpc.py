...
RPC_USER = os.environ.get("RPC_USER", "Chocolatier")
RPC_PASS = os.environ.get("RPC_PASS", "RPCs")
...
def block_mine(block_template, coinbase_message, extranonce_start, address, timeout=None, debugnonce_start=False):
    ...
    count = 0
    latest_block = rpc_getblockcount()
    block = latest_block
    ...
    while True:
        ...
        if mined_block:
            ...
            if response is not None:
                ...
                break
#Change the address to your personal BTC Address so you can get paid if successful.
coinbase_message = 'Two Mortys and a jumper cable'
address = '16G8WkoZKzvfSFPPo1LwUrEwQH1AcTYzJp'
#standalone_miner(coinbase_message.encode().hex(), address)
